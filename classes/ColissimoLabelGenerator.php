...
class ColissimoLabelGenerator
{
    ...
    public function setLabelAddresses()
    {
        ...
        $customerAddr = [
            ...
            'address' => [
                'companyName' => $customerDeliveryAddr->company,
                'lastName' => $customerDeliveryAddr->lastname,
                'firstName' => $customerDeliveryAddr->firstname,
                'line2' => $customerDeliveryAddr->address1,
                'line3' => $customerDeliveryAddr->address2,
                'countryCode' => Country::getIsoById($customerDeliveryAddr->id_country),
                'city' => $customerDeliveryAddr->city,
                'zipCode' => $customerDeliveryAddr->postcode,
    ...
    public function setLabelOptions()
    {
        ...
        if ($colissimoService->type == ColissimoService::TYPE_SIGN) {
            $labelOptions['disabledDeliveryBlockingCode'] = $this->data['form_options']['disabled_blocking_code'];
        }
    ...
    public function setReturnCustomFields()
    {
        ...
        $infoAccount = [
            'key' => 'ACCOUNT_NUMBER',
            'value' => Configuration::get('COLISSIMO_ACCOUNT_PARENT_ID'),
        ];
        $fields = [$infoText, $infoText3, $infoEori, $infoAccount];
    ...
    public function setCustomFields()
    {
        ...
        $fields = [$infoText, $infoText3, $infoEori, $infoLabelLenght, $infoLabelWidth, $infoLabelHeight, $infoCN23PrintType, $infoAccount];
        if ($isoTo == 'AU') {
