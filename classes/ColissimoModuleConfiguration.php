...
class ColissimoModuleConfiguration
{
    ...
    public $widgetFields = [
        ...
        'COLISSIMO_WIDGET_RELAY_FILTER',
        'COLISSIMO_OSM_RELAY_FILTER',
    ];
    ...
    public $widgetFieldsMobile = [
        ...
        'COLISSIMO_WIDGET_RELAY_FILTER_MOBILE',
        'COLISSIMO_OSM_RELAY_FILTER_MOBILE'
    ];
    ...
    /** @var array */
    public $deliveryDateConfigFields = [
        'COLISSIMO_DELIVERY_DATE_OPTIONS'
    ];
    ...
    public function getContent()
    {
        ...
        $deliveryDateConfigFields = Configuration::getMultiple($this->deliveryDateConfigFields);
        $deliveryDateConfigFields['COLISSIMO_DELIVERY_DATE_OPTIONS'] = json_decode(
            Configuration::get('COLISSIMO_DELIVERY_DATE_OPTIONS'),
            true
        );
        $deliveryDateConfigFields['COLISSIMO_SITE_DEPOT_LIST'] = $this->module->getEstimatedDeliveryDateInfo()['siteDepotList'];
        $deliveryDateConfigFields['COLISSIMO_DISPLAY_DELIVERY_DATE'] = $this->module->getEstimatedDeliveryDateInfo()['statutTunnelCommande'];
        ...
        $this->context->smarty->assign(
            [
                ...
                'coliship_enabled' => (int) !Configuration::get('COLISSIMO_GENERATE_LABEL_PRESTASHOP'),
