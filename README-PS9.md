...
Cette version est une adaptation non officielle. Les développeurs officiels de Colissimo prévoient de publier une version compatible PrestaShop 9 en 2026.
...
| **9.0.x** | **8.1+** | ✅ **Compatible (version patchée)** |
| 9.1.x+ | 8.1+ | ⚠️ À tester |
...
**⚠️ Important** : Cette version sera obsolète lorsque la version officielle compatible PrestaShop 9 sera publiée par les développeurs de Colissimo (prévu en 2026).
