            ...
            <div>
                <table class="table colissimo-configuration-table">
                    ...
                    <tr>
                        ...
                        {if isset($blocking_code)}
                            <th>
                                <span class="title_box text-center">{l s='Activate secure code' mod='colissimo'}</span>
                            </th>
                        {/if}
                ...
                <br/>{l s='return label' mod='colissimo'}</span>
                        ...
                        <th><span class="title_box text-center">{l s='DDP for the DOM' mod='colissimo'}</span></th>
                        <th>
                    ...
                    {foreach $orders as $key => $order}
                        <tr class="row-id-order-{$order.id_order|intval}">
                            ...
                            {if isset($blocking_code)}
                                <td class="text-center colissimo-blocking-code">
                                    <input class="colissimo-blocking-code"
                                           type="checkbox"
                                           name="colissimo_blocking_code_{$key|intval}"
                                           {if $order.order_blocking_code}checked="checked" {else}disabled{/if}>
                                </td>
                            {/if}
