        ...
        <span class="label-tooltip"
          ...
          <span class="switch prestashop-switch fixed-width-lg">
            ...
            <div class="form-group">
                <label class="control-label col-lg-3 ">
          <span>
            {l s='Choice of carrier for Belgium' mod='colissimo'}
          </span>
                </label>
                <div class="col-lg-9">
          <span class="switch prestashop-switch fixed-width-lg">
            <input type="radio"
                   value="1"
                   name="COLISSIMO_POSTAL_PARTNER_BE"
                   id="COLISSIMO_POSTAL_PARTNER_BE_on"
                   {if $form_data['COLISSIMO_POSTAL_PARTNER_BE']|intval}checked="checked"{/if}>
            <label for="COLISSIMO_POSTAL_PARTNER_BE_on">{l s='Part.postal' mod='colissimo'}</label>
            <input type="radio"
                   value="0"
                   name="COLISSIMO_POSTAL_PARTNER_BE"
                   id="COLISSIMO_POSTAL_PARTNER_BE_off"
                   {if !$form_data['COLISSIMO_POSTAL_PARTNER_BE']|intval}checked="checked"{/if}>
            <label for="COLISSIMO_POSTAL_PARTNER_BE_off">{l s='DPD' mod='colissimo'}</label>
            <a class="slide-button btn"></a>
          </span>
                </div>
                <div class="col-lg-9 col-lg-offset-3"></div>
