...
function toggleDelivaryDate() {
    if ($("#COLISSIMO_DISPLAY_DELIVERY_DATE_on").prop("checked")) {
        $(".colissimo-delivery-date-config").show(400);
    } else {
        $(".colissimo-delivery-date-config").hide(200);
    }
}
...
$(document).ready(function () {
    ...
    $(document).on("click", ".display-delivery-date span", function () {
        toggleDelivaryDate();
    });
    ...
    $(document).on('click', "#form-satisfaction-button", function () {
