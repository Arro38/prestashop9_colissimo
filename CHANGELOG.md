...
### Added
- Added Belgium as a postal partner
- Update DDP logic for US Customs

## [2.2.1] - 2025-07-22

### Added
- Addition of the estimated delivery date in the order checkout process
- Redesign of the horizontal and vertical navigation
- Identification of client module versions
- Addition of tracking information for PS Checkout

## [2.2.0] - 2025-05-14

### Added
- Added a link to the labels and packaging page
- Updated the satisfaction survey
- Changed from FTD to DDP for the French Overseas Territories
- Secured return information message on settings
- Tracking of return labels
- Added a taginfopartner
- New filters for pickup points
